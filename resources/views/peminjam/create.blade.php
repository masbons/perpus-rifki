...
@section('content')
    ...
    <h1 class="h2">Create Peminjam</h1>
...
@endif
    ...
    <div class="card-body">
    <form action="{{ route('peminjams.store') }}" method="post" enctype="multipart/form-data">
        @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>buku:</strong>
                <input type="text" name="id_buku" class="form-control" placeholder="">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
