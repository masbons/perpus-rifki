...
<form action="{{ URL('books.update', @$book->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
       ...
       <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
            <select class="form-control select2" style="width: 100%;" name="id_penulis" id="id" value="{{ old('nama',@$book->id_penulis) }}">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
            <select class="form-control select2" style="width: 100%;" name="id_kategori" id="id_penerbit">
